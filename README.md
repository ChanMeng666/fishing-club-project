...
<a href="https://fishing-club.pages.dev/">
  <img src="docs/showcase/hero.webp" alt="East Coast Anglers Club hero section — dark-themed landing page with a fly fisherman wading in a river, club name in bold yellow, and a Join Us call-to-action button" width="100%">
</a>

![Demo: scrolling through the East Coast Anglers Club homepage to reveal membership, event booking, and guide session cards, then navigating to the registration page](docs/showcase/demo.gif)
...
|---|---|---|
| <img src="docs/showcase/features.webp" width="520"> | <img src="docs/showcase/register.webp" width="520"> | <img src="docs/showcase/mobile-hero.webp" width="260"> |
